...
This guide shows how to apply the OVN License for Digital Resources v1.0 to documentation projects (technical writing, guides, educational materials, wikis).

## When to Use the OVN License for Docs

The OVN License is designed primarily for software, but its economic reciprocity provisions apply to any "digital resource" (per the license title). Documentation projects that benefit from contribution tracking and reciprocity -- such as collaboratively written technical guides, course materials, or knowledge bases -- can use this license.

For documentation that accompanies OVN-licensed software, using the same license simplifies compliance. Alternatively, consider CC-BY-SA-4.0 for documentation if economic reciprocity is not needed.
...
This work is licensed under the [OVN License for Digital Resources v1.0](LICENSE.md).
...
<footer>
  <p>This work is licensed under the
    <a href="LICENSE.md">OVN License for Digital Resources v1.0</a>.
    See the <a href="pie-chart.json">Contribution Pie-Chart</a> for
    contributor information.</p>
  <p>Copyright &copy; 2025 Your Name or Organization</p>
</footer>
```
...
[OVN License for Digital Resources v1.0](LICENSE.md).
See [pie-chart.json](pie-chart.json) for contributor shares.

Redistribution and use require compliance with the license's
reciprocity terms.
```
